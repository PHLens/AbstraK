"""Schedule-only TileLang canary.

The source intentionally uses non-core thread, pipeline, and GEMM policy
controls while keeping the same large-K GEMM contract as the core task.
"""
...
class ModelNew(nn.Module):
    """Schedule canary bound to the ``gemm-large-k-static`` contract."""
